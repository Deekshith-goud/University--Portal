...
class EventBase(BaseModel):
    ...
    is_open: bool = True
    eligibility: Optional[List[str]] = None # JSON List of allowed semesters (1-8)
    target_departments: Optional[List[str]] = None # JSON List of allowed departments (CSE, ECE...)
    venue: Optional[str] = None
    contact_phone: Optional[str] = None
    contact_email: Optional[str] = None
    coordinator_name: Optional[str] = None # New Coordinate Details
    coordinator_details: Optional[str] = None # Extra info
